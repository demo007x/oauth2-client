...
func TestNewAccessToken(t *testing.T) {
	...
	token := NewOauthAccessToken(serverURL, redirectURI, username, password, code, AccessTokenWithGrantType("authorization_code"), AccessTokenWithContentType("application/json"), AccessTokenWithResponseHandler(func(resp *http.Response) ([]byte, error) {
		defer func() {
